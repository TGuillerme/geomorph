---
title: "Quick Guide to geomorph 3.0.3"
...
|	|	findMeanSpec	|	modularity.test
|	|	fixed.angle	|	globalIntegration
|	|	mshape	|	gpagen
...
plotAllometry	|	larvalTails	|	define.sliders
plotAllSpecimens	|	mosquito	|	digit.curves
plotGMPhyloMorphoSpace	|	motionpaths	|	digit.fixed
plotOutliers	|	plethodon	|	digitize2d
plotRefToTarget	|	plethspecies	|	digitsurface
plotspec	|	plethShapeFood	|	editTemplate
plotTangentSpace	|	pupfish	|	read.ply
shape.predictor	|	ratland	|	
...
```{r eval=FALSE}
procD.allometry(f1, f2 = NULL, f3 = NULL, logsz = TRUE, iter = 999,
  seed = NULL, alpha = 0.05, RRPP = TRUE, , print.progress = TRUE, data = NULL, ...)
```
...
plethAllometry <- procD.allometry(shape~cs, logsz = TRUE, data=gdf, 
...
Allom <- procD.allometry(Y.gpa$coords ~ Y.gpa$Csize, print.progress = FALSE) 
